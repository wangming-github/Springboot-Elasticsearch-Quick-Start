...
|      |                                                              |
| ---- | ------------------------------------------------------------ |
|      | ![img](https://tva1.sinaimg.cn/large/e6c9d24egy1h4a70pvweuj20o0094mxo.jpg) |
...
|      |                                                              |
| ---- | ------------------------------------------------------------ |
|      | ![img](https://tva1.sinaimg.cn/large/e6c9d24egy1h4a70qq45aj20nv0axjs3.jpg) |
...
![img](https://tva1.sinaimg.cn/large/e6c9d24egy1h4a70r2uz1j20ns05l3z7.jpg)



字典树又称单词查找树，[Trie 树](https://baike.baidu.com/item/Trie树)，是一种[树形结构](https://baike.baidu.com/item/树形结构/9663807)，是一种哈希树的变种。典型应用是用于统计，排序和保存大量的[字符](https://baike.baidu.com/item/字符)串（但不仅限于字符串），所以经常被搜索引擎系统用于文本词频统计。它的优点是：利用字符串的公共前缀来减少查询时间，最大限度地减少无谓的字符串比较，查询效率比哈希树高。
...
倒排索引是搜索引擎的核心。搜索引擎的主要目标是在查找发生搜索条件的文档时提供快速搜索。ES中的倒排索引其实就是 lucene 的倒排索引，区别于传统的正向索引，倒排索引会再存储数据时将关键词和
